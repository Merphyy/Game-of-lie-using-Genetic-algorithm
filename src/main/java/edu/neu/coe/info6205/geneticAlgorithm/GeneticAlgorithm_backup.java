 ...
 *
 */
public class GeneticAlgorithm_backup {
	...
	public GeneticAlgorithm_backup(int populationSize, double mutationRate, double crossoverRate, int elitismCount) {
...
//							}
							// Mutate gene
							individual.setGene(i,j, newGene);
						}
					}
				}
			}
			
			//存入新solution前 先跑100次game of life
			stableGameOflife(individual);
